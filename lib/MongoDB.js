...
new MongoDB( 'default', 'users' )
    ...
    .then(
        inst => {
            ...
            inst.delete( [
                { _id: '5a0c6974ad2cc20d3ddd5030' },
                { _id: '5a0c6980cd30830d415fee33' },
                { hellos: 'worlds' }
            ] )
                .then( r => console.log( 'delete:', r ) )
                .catch( console.error );
            //
            // inst.getId( '5a0c4518bf00a10835fab97e' ).then( r => console.log( 'getID:', r ) );
            // inst.get( '5a0c4518bf00a10835fab97e' ).then( r => console.log( 'get:  ', r ) );
            
            // inst.put( { hello: 'world' } ).then( r => console.log( 'put:  ', r ) );
            // inst.put( [ { hellos: 'worlds' }, { array: 'here' } ] ).then( r => console.log( 'puts: ', r ) );
        }
    )
    .catch( console.error );
