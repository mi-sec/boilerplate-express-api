...
const
    ...
    findAuthCode = obj => findKeyInObj( obj, /auth_?code/i ),
...
function prepare( req, res, next ) {
    ...
    p.authcode = findAuthCode( { ...req.params, ...req.query, ...p.data, ...req.headers } ) || null;
    p.apikey   = findApiCode( { ...req.params, ...req.query, ...p.data, ...req.headers } ) || null;
    p.username = findUsername( { ...req.params, ...req.query, ...p.data, ...req.headers } ) || null;
    p.password = findPassword( { ...req.params, ...req.query, ...p.data, ...req.headers } ) || null;
